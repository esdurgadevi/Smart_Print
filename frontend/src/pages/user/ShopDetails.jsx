...
import { Store, MapPin, ArrowLeft, Package, Clock, ShieldCheck, ShoppingCart, Trash2, CheckCircle2, Star, MessageSquare, Phone, Mail, Navigation, X } from "lucide-react";
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden mb-12">
        <div className="h-48 md:h-64 bg-gray-100 relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
            ...
            <h1 className="text-4xl font-extrabold text-white mb-2 leading-tight flex items-center gap-2">
               {shop.shopName}
            </h1>
            ...
            {shop.services.map((service) => (
              <div key={service.id} className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 hover:shadow-lg transition-shadow duration-300 flex flex-col relative overflow-hidden group">
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <p className="text-gray-500 mt-2 mb-6 text-sm flex-1">{service.description}</p>
             ...
             <div className="space-y-3">
               {['monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday'].map((day) => (
                 <div key={day} className="flex justify-between items-center py-2 border-b border-gray-800 last:border-0">
                    <span className="capitalize text-xs font-semibold text-gray-400 tracking-wide">{day}</span>
